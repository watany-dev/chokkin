...
- **v0.2+**: tox/nox/pre-commit/GitHub Actions binary usage detection and static Flask/Celery app references are in progress; sphinx, mkdocs, and alembic remain planned.
