...
- **v0.2+**: tox/nox/pre-commit/GitHub Actions binary usage detection, static Flask/Celery app references, and conventional Sphinx/MkDocs/Alembic config entries are in progress.
