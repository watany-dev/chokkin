...
2. flask / celery — static app command/reference extraction is initial implementation (`FLASK_APP`, `flask --app`, `celery -A/--app`); Celery literal task decorator module refs are initial implementation
