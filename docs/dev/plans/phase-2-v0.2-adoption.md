...
1. workspace member discovery を Step 1/2 の後に追加する
2. member ごとの `LoadedManifest` / `SourceInventory` を保持する型を追加する
3. resolver に member boundary を渡す
...
1. tox / nox / pre-commit / github-actions
2. flask / celery
