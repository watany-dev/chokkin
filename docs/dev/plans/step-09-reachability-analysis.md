...
Step 8 の entry roots から BFS で **到達可能ファイル集合**を構築し、CHK001 と `--trace` の根拠データを供給する。
...
> - [`step-12-issue-emission.md`](./step-12-issue-emission.md) — CHK001 判定・confidence
...
| 後続ステップへの入力 | Step 10–12（used distributions / CHK001 / trace） |
...
| ルール / ポリシー | 20 | 19 | CHK001 は Step 12。confidence 入力を `Confidence` で統一 |
