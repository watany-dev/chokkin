...
pub use manifest::{
    ...
    ManifestWarning, ProjectMetadata, UvDefaultGroups, UvSource, UvSourceKind, UvToolSettings,
    discover_inline_scripts, extract_manifest, extract_manifest_with_cache, resolve_target_version,
};
pub use parser::{
