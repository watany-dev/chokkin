...
pub use manifest::{
    ...
    LockfileGraph, LockfileKind, LockfileSource, ManifestError, ManifestSources, ManifestWarning,
    ProjectMetadata, extract_manifest, extract_manifest_with_cache, resolve_target_version,
};
pub use parser::{
